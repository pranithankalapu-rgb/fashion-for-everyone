  ...
  try {
    ...
    const initialDesigners = [
      ...
      },
      {
        ...
        approvalStatus: 'Approved',
        status: 'Active',
        email: 'kaelen.mercer@streetwear.io',
      },
      {
        id: 'des_3',
    ...
    const initialDesigns = [
      ...
      },
      {
        ...
        designerId: 'des_1',
        designerName: 'Aria Vance',
        designerAvatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=300&q=80',
      ...
      },
      {
        ...
        designerAvatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=300&q=80',
