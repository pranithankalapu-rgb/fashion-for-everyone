        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-sm text-theme-secondary">
              Generated by combining your <strong className="text-amber-800 dark:text-amber-300">{userProfile.skinTone}</strong> undertones and <strong className="text-amber-800 dark:text-amber-300">{userProfile.bodyShape}</strong> silhouette rules with 42,000+ community votes on color harmony.
            </p>
          </div>
          ...
          <div className="bg-surface-theme border border-theme-main p-4 rounded-2xl text-xs space-y-2 text-theme-secondary min-w-[240px]">
            <div className="flex justify-between items-center pb-2 border-b border-theme-main">
              <span className="font-bold text-theme-heading">Body Vector</span>
            ...
            <div className="flex justify-between">
              <span className="text-theme-muted">Match Confidence:</span>
              <span className="text-emerald-400 font-bold">{aiAnalysis?.overallMatch || 98.4}%</span>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="p-5 space-y-4 flex-1 flex flex-col justify-between">
              <div>
                ...
                <p className="text-xs text-theme-muted mt-1">
                  Validated for <strong className="text-theme-secondary">{combo.occasion}</strong> occasion. Matches your <span className="text-amber-300 font-medium">{userProfile.skinTone}</span> undertones.
                </p>
              </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {RETAIL_PRODUCTS.slice(0, 2).map((prod) => (
                    <button
                      ...
                      className="flex items-center gap-2 p-2 rounded-xl bg-surface-theme hover:bg-surface-subtle-theme border border-theme-main text-left transition-all"
                    >
